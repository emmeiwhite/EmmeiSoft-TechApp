/** Static Site Generation:
  ...
  But for Blog pages usually the content for each Blog stays the same. And here is when we can make use of a concept called Static Site Generation. Now on build time itself our Blog pages will get generated.
